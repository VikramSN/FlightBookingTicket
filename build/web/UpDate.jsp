...
<!--              <input type="password" name="UpDate" class="form-control" value="${profile.getPass()}" placeholder="password">
             <br>-->
              <input type="text" name="UpDate" class="form-control" value="${profile.getContact()}" maxlength="10">
              <br>
              
<!--              <textarea  name="UpDate" class="form-control" value="" placeholder="address">${profile.getRepass()}</textarea>
              <br>
              -->
