...
<h1>Know About Us</h1>
<span class="brk"></span>
<p>its a commercial website for booking Flight ticket,The main AIM of this website is provide best service to customer,
this website also know as <b>PhoenixAirways</b>.</p>
...
<div class="wel-info text-center" style="color:#fff;">
...
<div class="row">
  ...
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
        <p></p>
       <img class="team-pic" src="images/pic4.jpg">
      <div class="caption">
        <h3>Mr. Sagar Pant</h3>
    ...
    <div class="thumbnail" >
      <p></p>
      <img class="team-pic" src="images/pic1.jpg">
      <div class="caption">
        <h3>Mr. Vikram Singh Negi</h3>
        <p class="card-description">Gniit Revolution is a team of training student, who developed Software Applications,Websites,Web Application etc.</p>
      </div>
    </div>
  </div>
    ...
    <div class="thumbnail">
      <p></p>
      <img class="team-pic" src="images/pic2.jpg">
      <div class="caption">
        <h3>Miss. Neha</h3>
    ...
    <div class="thumbnail">
      <p></p>
      <img class="team-pic" src="images/pic3.png">
      <div class="caption">
        <h3>Mr. Salman</h3>
...
<p class="rights"> dont remove link <a class="dont-remove" href="http://webdeveloperbareilly.in" target="_blank">www.PhoenixAirways.com</a></p>
