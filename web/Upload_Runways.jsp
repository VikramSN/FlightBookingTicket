<%-- 
    Document   : Upload_Runways
    Created on : 30 Dec, 2017, 6:39:16 PM
    Author     : MD. SALMAN
--%>
...
<html>
    <head>
        ...
        <title>Upload-Runways Page</title>
    ...
    <body>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" >
                                <ul class="nav nav-tabs" id="mytabs">
                                    <li class="active"><a href="#tab1" style="color:darkslateblue"><b>Runways Details</b></a></li>
                                </ul>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="tab-content clearfix">
                                    <div class="tab-pane fade in active" id="tab1">
                                        <form style="color:#000" action="RunwayUpload" method="POST" enctype="multipart/form-data">
                                           
                                            <div class="styled-input">
                                                <input type="plain" required list="sts" name="runwayState" id="select1"/>
                                                <label>State</label>
                                            ...
                                            <div class="styled-input">
                                                <input type="date" required name="runwayDate" maxlength="6" value = "2018-02-05"/>
                                                <label>Date</label>
                                                <span></span> </div>
                                            
                                            <div class="styled-input" style="margin-right: 250px; margin-top: 20px;">
                                                
                                                <input type="file" name="runwayImage" multiple="multiple" required>
                                                <label>Upload Runways Image</label>
                                                <span></span> </div>

                                            <div class="listgroup">
                                                <label>Runways Name</label>
                                                <sub style="font-size:13px; color:red;">
                                                    <select class="selectpicker" id="select2" name="runwayName">
                                                        <option></option>
                            ...
                            <div class="panel-footer" style="background-color:green">Fill all details of Runways</div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            $("#select1").change(function () {
               ...
               var val= $("#select2 option:selected").text();
               alert(val);
